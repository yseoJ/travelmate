...
<body>
	...
	<br><br><br>
	<div style="text-align: center;"><a style="font-weight:bold; margin: auto;">매너 평가</a></div><br><br>
	<%     
	...
	%>
	<hr>
	<div style="text-align: center;"><a style="font-weight:bold; margin: auto;">비매너 평가</a></div><br><br>
	<%     
	sql = "SELECT i.EVAL_ITEM evalItem, e.EVAL_ID, COUNT(*) count "+
			"FROM MEMB_EVALUATION e "+
			"LEFT OUTER JOIN EVALUATION_ITEM i ON e.EVAL_ID = i.EVAL_ID "+
