		...
		<form name="frmTripInfo" action="tripInfo.jsp" method="get" style="text-align: center;" >
			...
			<div style="display: flex">
				<div style="flex: 3; float:left; width: 75%;">
					<br><div class="trip_list_title"><%=TRIP_TITLE%></div>
					<br>
					<!-- 여행 날짜 -->
					...
					<div style="font-size: 13px; display: inline-block;">&nbsp;<%=TRIP_MEET_DATE%></div>
					<br>
					<!-- 모집 인원 -->
					...
					<div style="font-size: 13px; display: inline-block;">&nbsp;<%=JOIN_NUM %> / <%=TOT_NUM %></div>
					<br><br>
				</div>
				<div style="flex: 1;">
