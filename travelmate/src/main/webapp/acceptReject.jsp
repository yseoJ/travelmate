...
<body>
	...
	<form name="frmInex" action="index.jsp" method="get" >
		<button onClick="window.close();" style=" display: inline-block; border-radius: 6px; background-color: rgba(13, 45, 132); color: rgba(13, 45, 132); color: white; height: 25px;">확인</button>
