...
<body style="line-height: 200%">
	...
	<form name="frmMakeTrip" action="makeTrip.jsp" method="get" >
		<button class="makeTripButton" type="submit" style="color: white; font-size: 22px; margin-left: 8%; border-radius: 5em; width: 300px; margin-bottom: 4%; background-color: rgb(13, 45, 132); border: 2px solid rgb(13, 45, 132);">선택하기</button>
